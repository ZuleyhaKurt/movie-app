...
const Navbar = () => {
  ...
  return (
    <>
      <nav className="w-full flex flex-wrap items-center justify-between py-3 bg-yellow-500 dark:bg-gray-900 dark:text-white shadow-lg navbar navbar-expand-lg fixed-top">
